                    ...
                    <div className="my-3 aboutjust" style={{ backgroundColor: 'rgba(228, 227, 227, 0.778)' }}>
                        ...
                        <div className="p-4">
                            ...
                            <p className="aboutjust">The small, everyday choices you make about your diet, fitness, and
                                ...
                                come to Nutri-Plus seeking answers to their health questions.
                    ...
                    <div className="my-3 aboutjust" style={{ backgroundColor: 'rgba(228, 227, 227, 0.778)' }}>
                        ...
                        <div className="p-4">
                            ...
                            <p className="aboutjust">Now, more than ever, people are going online for their news. It is our
                                responsibility to ensure that every piece of news published on Nutri-Plus is held to the
                                ...
                                research to the latest guidelines, Nuti-Plus goes beyond breaking news—we provide the
