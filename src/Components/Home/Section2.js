                ...
                <div className="row my-2">
                    <div className="col-md-7 mb-3 mb-sm-0 order-2">
                        ...
                        <div className="box1 ">
                            ...
                            <p>
                                At NUTRI-PLUS, we understand the importance of providing our users with trustworthy data, which is why we rely on authenticated APIs to gather information from reputable sources. Our commitment to excellence drives us to integrate top-tier APIs like the news API, recipe API, and nutrition API, ensuring that the information we deliver is always up-to-date and accurate.
                            </p>
